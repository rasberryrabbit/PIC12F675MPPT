...
;12f675 MPPT.mpas,209 :: 		power_curr:= adc_cur * adc_vol;
	...
	MOVF       R0+3, 0
	MOVWF      _power_curr+3
;12f675 MPPT.mpas,210 :: 		if power_curr=power_prev then begin
	MOVF       R0+3, 0
...
;12f675 MPPT.mpas,211 :: 		Inc_pwm:=0;
	CLRF       _Inc_pwm+0
;12f675 MPPT.mpas,212 :: 		if adc_cur>adc_prev then begin
	MOVF       _adc_cur+1, 0
	SUBWF      _adc_prev+1, 0
	BTFSS      STATUS+0, 2
	GOTO       L__main75
...
L__main75:
	BTFSC      STATUS+0, 0
	GOTO       L__main46
;12f675 MPPT.mpas,213 :: 		flag_inc:=False;
	CLRF       _flag_inc+0
;12f675 MPPT.mpas,214 :: 		end else
	GOTO       L__main47
L__main46:
...
L__main76:
	BTFSC      STATUS+0, 0
	GOTO       L__main49
;12f675 MPPT.mpas,216 :: 		flag_inc:=True;
	MOVLW      255
	MOVWF      _flag_inc+0
...
L__main50:
L__main47:
;12f675 MPPT.mpas,220 :: 		vol2:=0;
	CLRF       _vol2+0
;12f675 MPPT.mpas,221 :: 		LED1_tm:=240;
	MOVLW      240
	MOVWF      _LED1_tm+0
;12f675 MPPT.mpas,222 :: 		continue;
	GOTO       L__main12
;12f675 MPPT.mpas,223 :: 		end else begin
L__main43:
;12f675 MPPT.mpas,224 :: 		if Inc_pwm<Inc_Pwm_Max then
	MOVLW      7
	SUBWF      _Inc_pwm+0, 0
	BTFSC      STATUS+0, 0
	GOTO       L__main52
;12f675 MPPT.mpas,225 :: 		Inc(Inc_pwm);
	INCF       _Inc_pwm+0, 1
L__main52:
;12f675 MPPT.mpas,226 :: 		if power_curr<power_prev then begin
...
L__main77:
	BTFSC      STATUS+0, 0
	GOTO       L__main55
;12f675 MPPT.mpas,228 :: 		vol1:=VOL_PWM;
	MOVF       _VOL_PWM+0, 0
	MOVWF      _vol1+0
;12f675 MPPT.mpas,229 :: 		flag_inc:=not flag_inc;
	COMF       _flag_inc+0, 1
;12f675 MPPT.mpas,231 :: 		if vol2<>0 then begin
	MOVF       _vol2+0, 0
	XORLW      0
	BTFSC      STATUS+0, 2
	GOTO       L__main58
;12f675 MPPT.mpas,232 :: 		Inc_pwm:=0;
	CLRF       _Inc_pwm+0
;12f675 MPPT.mpas,233 :: 		wPWM:=vol1;
	MOVF       _vol1+0, 0
	MOVWF      _wPWM+0
	CLRF       _wPWM+1
;12f675 MPPT.mpas,234 :: 		wPWM:=(wPWM+vol2+1) div 2+1;
	MOVF       _vol2+0, 0
	ADDWF      _wPWM+0, 1
	BTFSC      STATUS+0, 0
	INCF       _wPWM+1, 1
	...
	BTFSC      STATUS+0, 2
	INCF       _wPWM+1, 1
;12f675 MPPT.mpas,235 :: 		VOL_PWM:=lo(wPWM);
	MOVF       _wPWM+0, 0
	MOVWF      _VOL_PWM+0
;12f675 MPPT.mpas,237 :: 		vol2:=0;
	CLRF       _vol2+0
;12f675 MPPT.mpas,239 :: 		wPWM:=(PWM_MAX-VOL_PWM+((PWMHI_DIV+1) div 2)) div PWMHI_DIV;
	MOVF       _wPWM+0, 0
	SUBLW      255
	MOVWF      R0+0
	MOVLW      0
	...
	MOVF       R0+1, 0
	MOVWF      _wPWM+1
;12f675 MPPT.mpas,240 :: 		wPWM:=wPWM+VOL_PWM;
	MOVF       _VOL_PWM+0, 0
	ADDWF      R0+0, 0
	MOVWF      _wPWM+0
	MOVF       R0+1, 0
	...
	ADDLW      1
	MOVWF      _wPWM+1
;12f675 MPPT.mpas,241 :: 		hi_PWM:=lo(wPWM);
	MOVF       _wPWM+0, 0
	MOVWF      _hi_PWM+0
;12f675 MPPT.mpas,243 :: 		wPWM:=(VOL_PWM-PWM_LOW+((PWMLO_DIV+1) div 2)) div PWMLO_DIV;
	MOVLW      1
	SUBWF      _VOL_PWM+0, 0
	MOVWF      R0+0
	MOVLW      0
	...
	MOVF       R0+1, 0
	MOVWF      _wPWM+1
;12f675 MPPT.mpas,244 :: 		wPWM:=VOL_PWM-wPWM;
	MOVF       R0+0, 0
	SUBWF      _VOL_PWM+0, 0
	MOVWF      _wPWM+0
	MOVF       R0+1, 0
	...
	CLRF       _wPWM+1
	SUBWF      _wPWM+1, 1
;12f675 MPPT.mpas,245 :: 		lo_PWM:=lo(wPWM);
	MOVF       _wPWM+0, 0
	MOVWF      _lo_PWM+0
;12f675 MPPT.mpas,246 :: 		continue;
	GOTO       L__main12
;12f675 MPPT.mpas,247 :: 		end;
L__main58:
;12f675 MPPT.mpas,248 :: 		end else begin
	GOTO       L__main56
L__main55:
;12f675 MPPT.mpas,250 :: 		vol2:=VOL_PWM;
	MOVF       _VOL_PWM+0, 0
	MOVWF      _vol2+0
;12f675 MPPT.mpas,251 :: 		end;
L__main56:
;12f675 MPPT.mpas,253 :: 		end else begin
	GOTO       L__main38
L__main37:
;12f675 MPPT.mpas,255 :: 		power_curr:=0;
	CLRF       _power_curr+0
	CLRF       _power_curr+1
	CLRF       _power_curr+2
	CLRF       _power_curr+3
;12f675 MPPT.mpas,256 :: 		Inc_pwm:=Inc_Pwm_Max;
	MOVLW      7
	MOVWF      _Inc_pwm+0
;12f675 MPPT.mpas,257 :: 		flag_inc:=True;
	MOVLW      255
	MOVWF      _flag_inc+0
;12f675 MPPT.mpas,258 :: 		vol2:=0;
	CLRF       _vol2+0
;12f675 MPPT.mpas,259 :: 		lo_PWM:=0;
	CLRF       _lo_PWM+0
;12f675 MPPT.mpas,260 :: 		hi_PWM:=PWM_MAX;
	MOVLW      255
	MOVWF      _hi_PWM+0
;12f675 MPPT.mpas,261 :: 		end;
L__main38:
;12f675 MPPT.mpas,263 :: 		if flag_inc then begin
	MOVF       _flag_inc+0, 0
	BTFSC      STATUS+0, 2
	GOTO       L__main61
;12f675 MPPT.mpas,264 :: 		if VOL_PWM<(hi_PWM-Inc_pwm) then begin
	MOVF       _Inc_pwm+0, 0
	SUBWF      _hi_PWM+0, 0
	MOVWF      R1+0
	MOVF       R1+0, 0
	...
	BTFSC      STATUS+0, 0
	GOTO       L__main64
;12f675 MPPT.mpas,265 :: 		VOL_PWM:=VOL_PWM+Inc_pwm;
	MOVF       _Inc_pwm+0, 0
	ADDWF      _VOL_PWM+0, 1
;12f675 MPPT.mpas,266 :: 		end else
	GOTO       L__main65
L__main64:
;12f675 MPPT.mpas,267 :: 		VOL_PWM:=hi_PWM;
	MOVF       _hi_PWM+0, 0
	MOVWF      _VOL_PWM+0
L__main65:
;12f675 MPPT.mpas,268 :: 		end else begin
	GOTO       L__main62
L__main61:
;12f675 MPPT.mpas,269 :: 		if VOL_PWM>(lo_PWM+(Inc_Pwm_Max+1-Inc_pwm)) then begin
	MOVF       _Inc_pwm+0, 0
	SUBLW      8
	MOVWF      R0+0
	MOVF       R0+0, 0
	...
	BTFSC      STATUS+0, 0
	GOTO       L__main67
;12f675 MPPT.mpas,270 :: 		VOL_PWM:=VOL_PWM-(Inc_Pwm_Max+1-Inc_pwm);
	MOVF       _Inc_pwm+0, 0
	SUBLW      8
	MOVWF      R0+0
	MOVF       R0+0, 0
	SUBWF      _VOL_PWM+0, 1
;12f675 MPPT.mpas,271 :: 		end else
	GOTO       L__main68
L__main67:
;12f675 MPPT.mpas,272 :: 		VOL_PWM:=lo_PWM;
	MOVF       _lo_PWM+0, 0
	MOVWF      _VOL_PWM+0
L__main68:
