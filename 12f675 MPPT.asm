...
;12f675 MPPT.mpas,111 :: 		offset_cur:=current_min;
	...
	MOVWF      _offset_cur+0
	CLRF       _offset_cur+1
;12f675 MPPT.mpas,112 :: 		last_cur:=0;
	CLRF       _last_cur+0
	CLRF       _last_cur+1
;12f675 MPPT.mpas,114 :: 		Hi(offset_cur):=EEPROM_Read(0);
	CLRF       FARG_EEPROM_Read_address+0
	CALL       _EEPROM_Read+0
	MOVF       R0+0, 0
	MOVWF      _offset_cur+1
;12f675 MPPT.mpas,115 :: 		Lo(offset_cur):=EEPROM_Read(1);
	MOVLW      1
	MOVWF      FARG_EEPROM_Read_address+0
	CALL       _EEPROM_Read+0
	MOVF       R0+0, 0
	MOVWF      _offset_cur+0
;12f675 MPPT.mpas,117 :: 		VCFG_bit:=1;
	BSF        VCFG_bit+0, BitPos(VCFG_bit+0)
;12f675 MPPT.mpas,118 :: 		CHS1_bit:=1;
	BSF        CHS1_bit+0, BitPos(CHS1_bit+0)
;12f675 MPPT.mpas,119 :: 		ADFM_bit:=1;
	BSF        ADFM_bit+0, BitPos(ADFM_bit+0)
;12f675 MPPT.mpas,121 :: 		OPTION_REG:=%01010000;        // ~2KHz @ 4MHz, enable weak pull-up
	MOVLW      80
	MOVWF      OPTION_REG+0
;12f675 MPPT.mpas,122 :: 		TMR0IE_bit:=1;
	BSF        TMR0IE_bit+0, BitPos(TMR0IE_bit+0)
;12f675 MPPT.mpas,124 :: 		PEIE_bit:=1;
	BSF        PEIE_bit+0, BitPos(PEIE_bit+0)
;12f675 MPPT.mpas,126 :: 		T1CKPS0_bit:=1;               // timer prescaler 1:2
	BSF        T1CKPS0_bit+0, BitPos(T1CKPS0_bit+0)
;12f675 MPPT.mpas,127 :: 		TMR1CS_bit:=0;
	BCF        TMR1CS_bit+0, BitPos(TMR1CS_bit+0)
;12f675 MPPT.mpas,128 :: 		TMR1IE_bit:=1;
...
;12f675 MPPT.mpas,139 :: 		VOL_PWM:=PWM_START;
	MOVLW      242
	MOVWF      _VOL_PWM+0
;12f675 MPPT.mpas,140 :: 		flag_inc:=False;
	CLRF       _flag_inc+0
;12f675 MPPT.mpas,141 :: 		offset_reset:=False;
	CLRF       _offset_reset+0
;12f675 MPPT.mpas,143 :: 		while True do begin
L__main24:
;12f675 MPPT.mpas,145 :: 		adc_cur:=Adc_Readx(2);
	...
	MOVF       R0+1, 0
	MOVWF      _adc_cur+1
;12f675 MPPT.mpas,147 :: 		if adc_cur>offset_cur then begin
	MOVF       R0+1, 0
...
L__main62:
	BTFSC      STATUS+0, 0
	GOTO       L__main29
;12f675 MPPT.mpas,148 :: 		offset_reset:=False;
	CLRF       _offset_reset+0
...
;12f675 MPPT.mpas,151 :: 		power_curr:= adc_cur * adc_vol;
	...
	MOVF       R0+3, 0
	MOVWF      _power_curr+3
;12f675 MPPT.mpas,152 :: 		if power_curr<power_prev then
...
L__main63:
	BTFSC      STATUS+0, 0
	GOTO       L__main32
;12f675 MPPT.mpas,153 :: 		flag_inc:=not flag_inc
	COMF       _flag_inc+0, 1
	GOTO       L__main33
;12f675 MPPT.mpas,154 :: 		else
L__main32:
;12f675 MPPT.mpas,155 :: 		if last_cur>adc_cur then
	MOVF       _last_cur+1, 0
	SUBWF      _adc_cur+1, 0
	BTFSS      STATUS+0, 2
	GOTO       L__main64
...
L__main64:
	BTFSC      STATUS+0, 0
	GOTO       L__main35
;12f675 MPPT.mpas,156 :: 		flag_inc:=not flag_inc;
	COMF       _flag_inc+0, 1
L__main35:
L__main33:
;12f675 MPPT.mpas,157 :: 		if flag_inc then begin
	MOVF       _flag_inc+0, 0
	BTFSC      STATUS+0, 2
	GOTO       L__main38
;12f675 MPPT.mpas,158 :: 		if VOL_PWM<PWM_MAX then
	MOVLW      255
	SUBWF      _VOL_PWM+0, 0
	BTFSC      STATUS+0, 0
	GOTO       L__main41
;12f675 MPPT.mpas,159 :: 		Inc(VOL_PWM);
	INCF       _VOL_PWM+0, 1
L__main41:
;12f675 MPPT.mpas,160 :: 		end else begin
	GOTO       L__main39
L__main38:
;12f675 MPPT.mpas,161 :: 		if VOL_PWM>PWM_LOW then
	MOVF       _VOL_PWM+0, 0
	SUBLW      0
	BTFSC      STATUS+0, 0
	GOTO       L__main44
;12f675 MPPT.mpas,162 :: 		Dec(VOL_PWM);
	DECF       _VOL_PWM+0, 1
L__main44:
;12f675 MPPT.mpas,163 :: 		end;
L__main39:
;12f675 MPPT.mpas,164 :: 		power_prev:=power_curr;
...
;12f675 MPPT.mpas,165 :: 		end else begin
	GOTO       L__main30
L__main29:
;12f675 MPPT.mpas,166 :: 		if not offset_reset then begin
	COMF       _offset_reset+0, 0
	MOVWF      R0+0
	BTFSC      STATUS+0, 2
	GOTO       L__main47
;12f675 MPPT.mpas,167 :: 		VOL_PWM:=PWM_START;
	MOVLW      242
	MOVWF      _VOL_PWM+0
;12f675 MPPT.mpas,168 :: 		flag_inc:=False;
	CLRF       _flag_inc+0
;12f675 MPPT.mpas,169 :: 		power_prev:=0;
	CLRF       _power_prev+0
	CLRF       _power_prev+1
	CLRF       _power_prev+2
	CLRF       _power_prev+3
;12f675 MPPT.mpas,170 :: 		offset_reset:=True;
	MOVLW      255
	MOVWF      _offset_reset+0
;12f675 MPPT.mpas,171 :: 		end else begin
	GOTO       L__main48
L__main47:
;12f675 MPPT.mpas,172 :: 		if VOL_PWM<PWM_MAX then
	MOVLW      255
	SUBWF      _VOL_PWM+0, 0
	BTFSC      STATUS+0, 0
	GOTO       L__main50
;12f675 MPPT.mpas,173 :: 		Inc(VOL_PWM);
	INCF       _VOL_PWM+0, 1
L__main50:
...
L__main30:
;12f675 MPPT.mpas,176 :: 		last_cur:=adc_cur;
	MOVF       _adc_cur+0, 0
	MOVWF      _last_cur+0
	MOVF       _adc_cur+1, 0
	MOVWF      _last_cur+1
;12f675 MPPT.mpas,178 :: 		if VOL_PWM=PWM_MAX then
	...
	BTFSS      STATUS+0, 2
	GOTO       L__main53
;12f675 MPPT.mpas,179 :: 		LED1_tm:=125
	MOVLW      125
	MOVWF      _LED1_tm+0
	GOTO       L__main54
;12f675 MPPT.mpas,180 :: 		else
L__main53:
;12f675 MPPT.mpas,181 :: 		if adc_cur<=offset_cur then
	MOVF       _adc_cur+1, 0
	SUBWF      _offset_cur+1, 0
	BTFSS      STATUS+0, 2
	GOTO       L__main65
