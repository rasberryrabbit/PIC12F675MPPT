...
;12f675 MPPT.mpas,97 :: 		pre_volt:=0;
	CLRF       _pre_volt+0
	CLRF       _pre_volt+1
...
;12f675 MPPT.mpas,151 :: 		LED1_tm:=64
	...
	MOVWF      _LED1_tm+0
	GOTO       L__main24
;12f675 MPPT.mpas,152 :: 		else if (VOL_PWM=PWM_LOW) then
L__main23:
	MOVF       _VOL_PWM+0, 0
	XORLW      1
	BTFSS      STATUS+0, 2
...
L__main73:
	BTFSC      STATUS+0, 0
	GOTO       L__main37
;12f675 MPPT.mpas,175 :: 		power_curr:= adc_cur * adc_vol;
	MOVF       _adc_cur+0, 0
	MOVWF      R0+0
	MOVF       _adc_cur+1, 0
	MOVWF      R0+1
	...
	MOVF       R0+3, 0
	MOVWF      _power_curr+3
;12f675 MPPT.mpas,176 :: 		if (vol1<>0) and (power_curr=power_prev) then begin
	MOVF       _vol1+0, 0
	XORLW      0
	MOVLW      255
	BTFSC      STATUS+0, 2
...
L__main74:
	...
	BTFSC      STATUS+0, 2
	GOTO       L__main40
;12f675 MPPT.mpas,181 :: 		if adc_cur>adc_prev then begin
	MOVF       _adc_cur+1, 0
	SUBWF      _adc_prev+1, 0
	BTFSS      STATUS+0, 2
	GOTO       L__main75
...
L__main75:
	BTFSC      STATUS+0, 0
	GOTO       L__main43
;12f675 MPPT.mpas,182 :: 		flag_inc:=False;
	CLRF       _flag_inc+0
;12f675 MPPT.mpas,183 :: 		Inc_pwm:=IncPWM_EQ;
	MOVF       _IncPWM_EQ+0, 0
	MOVWF      _Inc_pwm+0
;12f675 MPPT.mpas,184 :: 		end else
	GOTO       L__main44
L__main43:
...
L__main76:
	BTFSC      STATUS+0, 0
	GOTO       L__main46
;12f675 MPPT.mpas,186 :: 		flag_inc:=True;
	MOVLW      255
	MOVWF      _flag_inc+0
...
;12f675 MPPT.mpas,188 :: 		end else begin
	GOTO       L__main47
L__main46:
;12f675 MPPT.mpas,189 :: 		Inc_pwm:=0;
	CLRF       _Inc_pwm+0
;12f675 MPPT.mpas,190 :: 		LED1_tm:=240;
	MOVLW      240
	MOVWF      _LED1_tm+0
;12f675 MPPT.mpas,191 :: 		flag_inc:=not flag_inc;
	COMF       _flag_inc+0, 1
;12f675 MPPT.mpas,192 :: 		end;
L__main47:
L__main44:
;12f675 MPPT.mpas,193 :: 		vol2:=0;
	CLRF       _vol2+0
;12f675 MPPT.mpas,194 :: 		end else begin
	GOTO       L__main41
L__main40:
;12f675 MPPT.mpas,195 :: 		if Inc_pwm<Inc_Pwm_Max then
	MOVLW      10
	SUBWF      _Inc_pwm+0, 0
	BTFSC      STATUS+0, 0
	GOTO       L__main49
;12f675 MPPT.mpas,196 :: 		Inc(Inc_pwm);
	INCF       _Inc_pwm+0, 1
L__main49:
;12f675 MPPT.mpas,197 :: 		if power_curr<power_prev then begin
...
L__main77:
	BTFSC      STATUS+0, 0
	GOTO       L__main52
;12f675 MPPT.mpas,202 :: 		vol1:=vol2;
	MOVF       _vol2+0, 0
	MOVWF      _vol1+0
;12f675 MPPT.mpas,203 :: 		vol2:=VOL_PWM;
	MOVF       _VOL_PWM+0, 0
	MOVWF      _vol2+0
;12f675 MPPT.mpas,204 :: 		flag_inc:=not flag_inc;
	COMF       _flag_inc+0, 1
;12f675 MPPT.mpas,206 :: 		if (vol1<>0) and (vol2<>0) then begin
	MOVF       _vol1+0, 0
	XORLW      0
	MOVLW      255
	BTFSC      STATUS+0, 2
	...
	BTFSC      STATUS+0, 2
	GOTO       L__main55
;12f675 MPPT.mpas,207 :: 		Inc_pwm:=0;
	CLRF       _Inc_pwm+0
;12f675 MPPT.mpas,208 :: 		VOL_PWM:=(vol1+vol2) div 2;
	MOVF       _vol2+0, 0
	ADDWF      _vol1+0, 0
	MOVWF      _VOL_PWM+0
	RRF        _VOL_PWM+0, 1
	BCF        _VOL_PWM+0, 7
;12f675 MPPT.mpas,209 :: 		vol2:=0;
	CLRF       _vol2+0
;12f675 MPPT.mpas,210 :: 		continue;
	GOTO       L__main12
;12f675 MPPT.mpas,211 :: 		end;
L__main55:
;12f675 MPPT.mpas,212 :: 		end;
L__main52:
;12f675 MPPT.mpas,213 :: 		end;
L__main41:
;12f675 MPPT.mpas,214 :: 		end else begin
	GOTO       L__main38
L__main37:
;12f675 MPPT.mpas,216 :: 		power_curr:=0;
	CLRF       _power_curr+0
	CLRF       _power_curr+1
	CLRF       _power_curr+2
	CLRF       _power_curr+3
;12f675 MPPT.mpas,217 :: 		Inc_pwm:=Inc_Pwm_Max;
	MOVLW      10
	MOVWF      _Inc_pwm+0
;12f675 MPPT.mpas,218 :: 		flag_inc:=True;
	MOVLW      255
	MOVWF      _flag_inc+0
;12f675 MPPT.mpas,219 :: 		vol2:=0;
	CLRF       _vol2+0
;12f675 MPPT.mpas,220 :: 		end;
L__main38:
;12f675 MPPT.mpas,222 :: 		if flag_inc then begin
	MOVF       _flag_inc+0, 0
	BTFSC      STATUS+0, 2
	GOTO       L__main58
;12f675 MPPT.mpas,223 :: 		if VOL_PWM<(PWM_MAX-Inc_pwm) then begin
	MOVF       _Inc_pwm+0, 0
	SUBLW      255
	MOVWF      R1+0
	MOVF       R1+0, 0
	...
	BTFSC      STATUS+0, 0
	GOTO       L__main61
;12f675 MPPT.mpas,224 :: 		VOL_PWM:=VOL_PWM+Inc_pwm;
	MOVF       _Inc_pwm+0, 0
	ADDWF      _VOL_PWM+0, 1
;12f675 MPPT.mpas,225 :: 		end else
	GOTO       L__main62
L__main61:
;12f675 MPPT.mpas,226 :: 		VOL_PWM:=PWM_MAX;
	MOVLW      255
	MOVWF      _VOL_PWM+0
L__main62:
;12f675 MPPT.mpas,227 :: 		end else begin
	GOTO       L__main59
L__main58:
;12f675 MPPT.mpas,228 :: 		if VOL_PWM>(PWM_LOW+(Inc_Pwm_Max+1-Inc_pwm)) then begin
	MOVF       _Inc_pwm+0, 0
	SUBLW      11
	MOVWF      R0+0
	INCF       R0+0, 0
	...
	BTFSC      STATUS+0, 0
	GOTO       L__main64
;12f675 MPPT.mpas,229 :: 		VOL_PWM:=VOL_PWM-(Inc_Pwm_Max+1-Inc_pwm);
	MOVF       _Inc_pwm+0, 0
	SUBLW      11
	MOVWF      R0+0
	MOVF       R0+0, 0
	SUBWF      _VOL_PWM+0, 1
;12f675 MPPT.mpas,230 :: 		end else
	GOTO       L__main65
L__main64:
;12f675 MPPT.mpas,231 :: 		VOL_PWM:=PWM_LOW;
	MOVLW      1
	MOVWF      _VOL_PWM+0
L__main65:
;12f675 MPPT.mpas,232 :: 		end;
L__main59:
;12f675 MPPT.mpas,233 :: 		if adc_cur=0 then
	MOVLW      0
	XORWF      _adc_cur+1, 0
	BTFSS      STATUS+0, 2
	GOTO       L__main78
...
L__main78:
	BTFSS      STATUS+0, 2
	GOTO       L__main67
;12f675 MPPT.mpas,234 :: 		Delay_80us;
	CALL       _Delay_80us+0
L__main67:
