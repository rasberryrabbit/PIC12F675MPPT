...
;12f675 MPPT.mpas,94 :: 		OPTION_REG:=%01011000;        // ~4KHz @ 4MHz
	MOVLW      88
	MOVWF      OPTION_REG+0
...
;12f675 MPPT.mpas,141 :: 		adc_prev:=adc_cur;
	...
	MOVF       _adc_cur+1, 0
	MOVWF      _adc_prev+1
;12f675 MPPT.mpas,143 :: 		adc_vol:=0;
	CLRF       _adc_vol+0
	CLRF       _adc_vol+1
;12f675 MPPT.mpas,144 :: 		adc_cur:=0;
	CLRF       _adc_cur+0
	CLRF       _adc_cur+1
;12f675 MPPT.mpas,145 :: 		for i:=0 to 1 do begin
	CLRF       _i+0
L__main23:
;12f675 MPPT.mpas,146 :: 		adc_vol:=adc_vol+ADC_Read(3);
	MOVLW      3
	...
	ADDLW      1
	ADDWF      _adc_vol+1, 1
;12f675 MPPT.mpas,147 :: 		adc_cur:=adc_cur+ADC_Read(2);
	MOVLW      2
	MOVWF      FARG_ADC_Read_channel+0
	CALL       _ADC_Read+0
	MOVF       R0+0, 0
...
;12f675 MPPT.mpas,148 :: 		end;
	...
	GOTO       L__main23
L__main26:
;12f675 MPPT.mpas,149 :: 		adc_vol:=adc_vol div 2;
	RRF        _adc_vol+1, 1
	RRF        _adc_vol+0, 1
	BCF        _adc_vol+1, 7
;12f675 MPPT.mpas,150 :: 		adc_cur:=adc_cur div 2;
	MOVF       _adc_cur+0, 0
	MOVWF      R1+0
	MOVF       _adc_cur+1, 0
	MOVWF      R1+1
...
;12f675 MPPT.mpas,153 :: 		adc_cur:=adc_cur-LM358_diff
	...
	DECF       _adc_cur+1, 1
	GOTO       L__main29
;12f675 MPPT.mpas,154 :: 		else begin
L__main28:
;12f675 MPPT.mpas,155 :: 		adc_cur:=0;
	CLRF       _adc_cur+0
	CLRF       _adc_cur+1
;12f675 MPPT.mpas,156 :: 		power_prev:=0;
	CLRF       _power_prev+0
	CLRF       _power_prev+1
	CLRF       _power_prev+2
	CLRF       _power_prev+3
;12f675 MPPT.mpas,157 :: 		LED1_tm:=64;
	MOVLW      64
	MOVWF      _LED1_tm+0
;12f675 MPPT.mpas,158 :: 		flag_inc:=True;
	MOVLW      255
	MOVWF      _flag_inc+0
...
L__main61:
	BTFSC      STATUS+0, 0
	GOTO       L__main31
;12f675 MPPT.mpas,162 :: 		power_curr:= adc_cur * adc_vol;
	MOVF       _adc_cur+0, 0
	MOVWF      R0+0
	MOVF       _adc_cur+1, 0
	MOVWF      R0+1
	...
	MOVF       R0+3, 0
	MOVWF      _power_curr+3
;12f675 MPPT.mpas,163 :: 		if power_curr=power_prev then begin
	MOVF       R0+3, 0
...
L__main63:
	BTFSC      STATUS+0, 0
	GOTO       L__main37
;12f675 MPPT.mpas,165 :: 		Inc_pwm:=1;
	MOVLW      1
	MOVWF      _Inc_pwm+0
;12f675 MPPT.mpas,166 :: 		LED1_tm:=32;
	MOVLW      32
	MOVWF      _LED1_tm+0
;12f675 MPPT.mpas,167 :: 		flag_inc:=True;
	MOVLW      255
	MOVWF      _flag_inc+0
;12f675 MPPT.mpas,168 :: 		end else
	GOTO       L__main38
L__main37:
...
L__main64:
	BTFSC      STATUS+0, 0
	GOTO       L__main40
;12f675 MPPT.mpas,170 :: 		Inc_pwm:=1;
	MOVLW      1
	MOVWF      _Inc_pwm+0
;12f675 MPPT.mpas,171 :: 		LED1_tm:=32;
	MOVLW      32
	MOVWF      _LED1_tm+0
;12f675 MPPT.mpas,172 :: 		flag_inc:=False;
	CLRF       _flag_inc+0
;12f675 MPPT.mpas,173 :: 		end else begin
	GOTO       L__main41
L__main40:
;12f675 MPPT.mpas,174 :: 		Inc_pwm:=0;
	CLRF       _Inc_pwm+0
;12f675 MPPT.mpas,175 :: 		LED1_tm:=240;
	MOVLW      240
	MOVWF      _LED1_tm+0
;12f675 MPPT.mpas,176 :: 		flag_inc:=not flag_inc;
	COMF       _flag_inc+0, 1
...
;12f675 MPPT.mpas,178 :: 		end else begin
	GOTO       L__main35
L__main34:
;12f675 MPPT.mpas,179 :: 		LED1_tm:=120;
	MOVLW      120
	MOVWF      _LED1_tm+0
;12f675 MPPT.mpas,180 :: 		Inc(Inc_pwm);
	INCF       _Inc_pwm+0, 1
;12f675 MPPT.mpas,181 :: 		if Inc_pwm>Inc_Pwm_Max then
	MOVF       _Inc_pwm+0, 0
	SUBLW      2
	BTFSC      STATUS+0, 0
	GOTO       L__main43
;12f675 MPPT.mpas,182 :: 		Inc_pwm:=Inc_Pwm_Max;
	...
	MOVWF      _Inc_pwm+0
L__main43:
;12f675 MPPT.mpas,183 :: 		if power_curr<power_prev then
...
L__main65:
	BTFSC      STATUS+0, 0
	GOTO       L__main46
;12f675 MPPT.mpas,184 :: 		flag_inc:=not flag_inc;
	COMF       _flag_inc+0, 1
L__main46:
;12f675 MPPT.mpas,185 :: 		end;
L__main35:
;12f675 MPPT.mpas,186 :: 		power_prev:=power_curr;
	MOVF       _power_curr+0, 0
	MOVWF      _power_prev+0
	MOVF       _power_curr+1, 0
	MOVWF      _power_prev+1
...
L__main31:
;12f675 MPPT.mpas,189 :: 		if flag_inc then begin
	MOVF       _flag_inc+0, 0
	BTFSC      STATUS+0, 2
	GOTO       L__main49
;12f675 MPPT.mpas,190 :: 		if VOL_PWM<(PWM_MAX-Inc_pwm) then begin
	MOVF       _Inc_pwm+0, 0
	SUBLW      255
	MOVWF      R1+0
	MOVF       R1+0, 0
	...
	BTFSC      STATUS+0, 0
	GOTO       L__main52
;12f675 MPPT.mpas,191 :: 		VOL_PWM:=VOL_PWM+Inc_pwm;
	MOVF       _Inc_pwm+0, 0
	ADDWF      _VOL_PWM+0, 1
;12f675 MPPT.mpas,192 :: 		end else
	GOTO       L__main53
L__main52:
;12f675 MPPT.mpas,193 :: 		VOL_PWM:=PWM_MAX;
	MOVLW      255
	MOVWF      _VOL_PWM+0
L__main53:
;12f675 MPPT.mpas,194 :: 		end else begin
	GOTO       L__main50
L__main49:
;12f675 MPPT.mpas,195 :: 		if VOL_PWM>(PWM_LOW+(Inc_Pwm_Max+1-Inc_pwm)) then begin
	MOVF       _Inc_pwm+0, 0
	SUBLW      3
	MOVWF      R0+0
	INCF       R0+0, 0
	...
	BTFSC      STATUS+0, 0
	GOTO       L__main55
;12f675 MPPT.mpas,196 :: 		VOL_PWM:=VOL_PWM-(Inc_Pwm_Max+1-Inc_pwm);
	MOVF       _Inc_pwm+0, 0
	SUBLW      3
	MOVWF      R0+0
	MOVF       R0+0, 0
...
;12f675 MPPT.mpas,197 :: 		end else
	GOTO       L__main56
L__main55:
;12f675 MPPT.mpas,198 :: 		VOL_PWM:=PWM_LOW;
	MOVLW      1
	MOVWF      _VOL_PWM+0
L__main56:
