...
;12f675 MPPT.mpas,54 :: 		begin
;12f675 MPPT.mpas,55 :: 		if T0IF_bit=1 then begin
	BTFSS      T0IF_bit+0, BitPos(T0IF_bit+0)
	GOTO       L__Interrupt2
;12f675 MPPT.mpas,56 :: 		if PWM_FLAG=1 then begin
	BTFSS      _PWM_FLAG+0, BitPos(_PWM_FLAG+0)
	GOTO       L__Interrupt5
;12f675 MPPT.mpas,57 :: 		ON_PWM:=VOL_PWM;
	MOVF       _VOL_PWM+0, 0
	MOVWF      _ON_PWM+0
;12f675 MPPT.mpas,59 :: 		TMR0:=255-ON_PWM;
	MOVF       _VOL_PWM+0, 0
	SUBLW      255
	MOVWF      TMR0+0
;12f675 MPPT.mpas,60 :: 		PWM_SIG:=0;
	BCF        GP0_bit+0, BitPos(GP0_bit+0)
;12f675 MPPT.mpas,61 :: 		PWM_FLAG:=0;
	BCF        _PWM_FLAG+0, BitPos(_PWM_FLAG+0)
;12f675 MPPT.mpas,62 :: 		end else begin
	GOTO       L__Interrupt6
L__Interrupt5:
;12f675 MPPT.mpas,64 :: 		TMR0:=255-PWM_MAX+ON_PWM;
	MOVF       _ON_PWM+0, 0
	ADDLW      180
	MOVWF      TMR0+0
...
;12f675 MPPT.mpas,159 :: 		got_max:=False;
	CLRF       _got_max+0
;12f675 MPPT.mpas,160 :: 		eq_cnt:=eq_count_max;
	MOVLW      10
	MOVWF      _eq_cnt+0
;12f675 MPPT.mpas,161 :: 		eq_conti_cnt:=eq_conti_max;
	MOVLW      5
	MOVWF      _eq_conti_cnt+0
;12f675 MPPT.mpas,162 :: 		end else if power_curr=power_prev then begin
	GOTO       L__main35
L__main34:
	MOVF       _power_curr+3, 0
...
L__main75:
	BTFSS      STATUS+0, 2
	GOTO       L__main37
;12f675 MPPT.mpas,163 :: 		if got_max then begin
	MOVF       _got_max+0, 0
	BTFSC      STATUS+0, 2
	GOTO       L__main40
;12f675 MPPT.mpas,164 :: 		LED1_tm:=250;
	MOVLW      250
	MOVWF      _LED1_tm+0
;12f675 MPPT.mpas,165 :: 		if eq_cnt>0 then
	MOVF       _eq_cnt+0, 0
	SUBLW      0
	BTFSC      STATUS+0, 0
	GOTO       L__main43
;12f675 MPPT.mpas,166 :: 		Dec(eq_cnt);
	DECF       _eq_cnt+0, 1
L__main43:
;12f675 MPPT.mpas,167 :: 		if eq_cnt=0 then begin
	MOVF       _eq_cnt+0, 0
	XORLW      0
	BTFSS      STATUS+0, 2
	GOTO       L__main46
;12f675 MPPT.mpas,168 :: 		if eq_conti_cnt>0 then
	MOVF       _eq_conti_cnt+0, 0
	SUBLW      0
	BTFSC      STATUS+0, 0
	GOTO       L__main49
;12f675 MPPT.mpas,169 :: 		Dec(eq_conti_cnt);
	DECF       _eq_conti_cnt+0, 1
L__main49:
;12f675 MPPT.mpas,170 :: 		if eq_conti_cnt>0 then
	MOVF       _eq_conti_cnt+0, 0
	SUBLW      0
	BTFSC      STATUS+0, 0
	GOTO       L__main52
;12f675 MPPT.mpas,171 :: 		continue
	GOTO       L__main9
;12f675 MPPT.mpas,172 :: 		else begin
L__main52:
;12f675 MPPT.mpas,173 :: 		eq_conti_cnt:=eq_conti_max;
	MOVLW      5
	MOVWF      _eq_conti_cnt+0
;12f675 MPPT.mpas,174 :: 		flag_inc:=True;
	MOVLW      255
	MOVWF      _flag_inc+0
...
;12f675 MPPT.mpas,179 :: 		end else begin
	GOTO       L__main41
L__main40:
;12f675 MPPT.mpas,180 :: 		if not flag_inc then
	COMF       _flag_inc+0, 0
	MOVWF      R0+0
	BTFSC      STATUS+0, 2
	GOTO       L__main58
;12f675 MPPT.mpas,181 :: 		flag_inc:=not flag_inc;
	COMF       _flag_inc+0, 1
L__main58:
;12f675 MPPT.mpas,182 :: 		eq_cnt:=eq_count_max;
	MOVLW      10
	MOVWF      _eq_cnt+0
;12f675 MPPT.mpas,183 :: 		eq_conti_cnt:=eq_conti_max;
	MOVLW      5
	MOVWF      _eq_conti_cnt+0
...
;12f675 MPPT.mpas,185 :: 		end else begin
	GOTO       L__main38
L__main37:
;12f675 MPPT.mpas,186 :: 		got_max:=True;
	MOVLW      255
	MOVWF      _got_max+0
;12f675 MPPT.mpas,187 :: 		eq_cnt:=eq_count_max;
	MOVLW      10
	MOVWF      _eq_cnt+0
;12f675 MPPT.mpas,188 :: 		eq_conti_cnt:=eq_conti_max;
	MOVLW      5
	MOVWF      _eq_conti_cnt+0
...
;12f675 MPPT.mpas,190 :: 		end else begin
	GOTO       L__main32
L__main31:
;12f675 MPPT.mpas,191 :: 		flag_inc:=True;
	MOVLW      255
	MOVWF      _flag_inc+0
;12f675 MPPT.mpas,192 :: 		LED1_tm:=64;
	MOVLW      64
	MOVWF      _LED1_tm+0
;12f675 MPPT.mpas,193 :: 		got_max:=False;
	CLRF       _got_max+0
;12f675 MPPT.mpas,194 :: 		end;
L__main32:
;12f675 MPPT.mpas,196 :: 		if flag_inc then begin
	MOVF       _flag_inc+0, 0
	BTFSC      STATUS+0, 2
	GOTO       L__main61
;12f675 MPPT.mpas,197 :: 		if VOL_PWM<PWM_MAX then
	MOVLW      75
	SUBWF      _VOL_PWM+0, 0
	BTFSC      STATUS+0, 0
	GOTO       L__main64
;12f675 MPPT.mpas,198 :: 		Inc(VOL_PWM)
	INCF       _VOL_PWM+0, 1
	GOTO       L__main65
;12f675 MPPT.mpas,199 :: 		else
L__main64:
;12f675 MPPT.mpas,200 :: 		flag_inc:=False;
	CLRF       _flag_inc+0
L__main65:
;12f675 MPPT.mpas,201 :: 		end else begin
	GOTO       L__main62
L__main61:
;12f675 MPPT.mpas,202 :: 		if VOL_PWM>PWM_LOW then
	MOVF       _VOL_PWM+0, 0
	SUBLW      1
	BTFSC      STATUS+0, 0
	GOTO       L__main67
;12f675 MPPT.mpas,203 :: 		Dec(VOL_PWM)
	DECF       _VOL_PWM+0, 1
	GOTO       L__main68
;12f675 MPPT.mpas,204 :: 		else
L__main67:
;12f675 MPPT.mpas,205 :: 		flag_inc:=True;
	MOVLW      255
	MOVWF      _flag_inc+0
L__main68:
